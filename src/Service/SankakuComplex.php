...
class SankakuComplex extends Parser
{
    private $websiteUrl = "https://chan.sankakucomplex.com";

    public function parseRss() {
        $rssItems = $this->getPieItems("https://chan.sankakucomplex.com/post/atom");
        ...
        foreach($rssItems as $i) {
            ...
            if(!$item) {
                $item = new Item();
                $item->setUrl($url);
                $item->setWebsite("sankakucomplex");
            }
